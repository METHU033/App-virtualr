...
const HeroSection = () => {
  return (
    <div className="flex flex-col items center mt-6 lg:mt-20 Over-hidden">
...
<span className="bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text">
    ...
    for developers
        ...
        <div className="flex justify-center my-10">
            <a href="#" className="bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 mx rounded">
                Start for free
            </a>
